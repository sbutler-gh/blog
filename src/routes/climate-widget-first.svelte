...
<p>This is a banner that can be embedded on any page (e.g. an organization website, a blog, a news site, an article) in a single line of code:</p>
<div id="banner-div" style="">
</div>
<p>When people hit "submit", they receive email introductions to direct action groups in their area – helping them connect with direct action, and helping organizations connect with new members.</p>
<p>This doesn't require any changes for organizations.  They can keep their existing processes, and get the benefit of new members coming to their inbox.</p>
...
<p><em>Grist</em></p>
<img src="./grist_climate_widget_desktop.png">
<details><summary style="margin-bottom: 20px;">Browse more examples</summary>
 <p><em>The Intercept</em></p>
<img src="./intercept_climate_widget_desktop2.png">
<p><em>Extinction Rebellion</em></p>
<img src="./xr_climate_widget_desktop.png">
<p><em>Declare Emergency</em></p>
<img src="./de_climate_widget_desktop.png">
<p><em>Hot Take Podcast</em></p>
<img src="./hottake_climate_widget_desktop.png">
</details>
<div>
