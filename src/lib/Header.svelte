<script>
    let subscribe_open = false;

    function subscribeToggle() {

        if (subscribe_open == false) {
            subscribe_open = true; 
            document.getElementById('subscribe_form').style.display = 'flex'; 
        }
        else {
            subscribe_open = false; 
            document.getElementById('subscribe_form').style.display = 'none'; 
        }
    //    (subscribe_open == false) ? (function() { subscribe_open = true; document.getElementById('subscribe_form').style.display = 'block'; console.log(document.getElementById('subscribe_form')); } ) : (function() {subscribe_open = false; document.getElementById('subscribe_form').style.display = 'none';} );
    }
</script>
...
<a href="https://linkedin.com/in/sambutler8"><svg xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="svg2" sodipodi:version="0.32" inkscape:version="0.47 r22583" sodipodi:docname="linkedin.svg" inkscape:output_extension="org.inkscape.output.svg.inkscape" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 256 256" enable-background="new 0 0 256 256" xml:space="preserve">
  ...
  <g id="layer1" transform="translate(-373.642,-318.344)" inkscape:label="Layer 1" inkscape:groupmode="layer">
      ...
      <path id="rect1942" inkscape:export-filename="C:\Documents and Settings\Molumen\Desktop\path3511111.png" inkscape:export-xdpi="7.7063322" inkscape:export-ydpi="7.7063322" fill="#1D8CB5" d="   M583.659,328.849H419.625c-19.599,0-35.487,15.888-35.487,35.487v164.015c0,19.599,15.888,35.486,35.487,35.486h164.033   c19.599,0,35.487-15.888,35.487-35.486V364.337C619.146,344.738,603.257,328.849,583.659,328.849z"/>
      ...
      <path id="path1950" inkscape:export-filename="C:\Documents and Settings\Molumen\Desktop\path3511111.png" inkscape:export-xdpi="7.7063322" sodipodi:nodetypes="ccccsssc" inkscape:export-ydpi="7.7063322" opacity="0.7811" fill="url(#path1950_1_)" enable-background="new    " d="   M557.056,338.895H446.227c-29.337,0-52.955,23.81-52.955,53.385v108.127c0.95,23.087,4.603,8.491,11.555-17.075   c8.081-29.713,34.396-55.682,66.445-75.145c24.461-14.855,51.84-24.341,101.679-25.244   C601.216,382.432,598.721,346.26,557.056,338.895z"/>
  </g>
...
<a href="https://twitter.com/sambutlerUS">
<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-whatsapp" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="mediumseagreen" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
<a href="">
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 1024 1024" fill="" style="margin-left: 2px;">
...
<a href="mailto:hello@sambutler.us">
...
<!-- <h4 style="margin:0px;"><a href="/" target="_self">About</a></h4> -->
...
{#if subscribe_open == true}
<svg on:click={subscribeToggle} xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-x" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#444" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
{#if subscribe_open == false}
  <h4 on:click={subscribeToggle} style="margin:0px;">
    <svg style="vertical-align: text-top" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-send" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#191fd0" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
    <line x1="10" y1="14" x2="21" y2="3" />
    <path d="M21 3l-6.5 18a0.55 .55 0 0 1 -1 0l-3.5 -7l-7 -3.5a0.55 .55 0 0 1 0 -1l18 -6.5" />
  </svg> Subscribe</h4>
  <!-- <h4 on:click={subscribeToggle} style="margin:0px;">
    <svg style="vertical-align: text-top" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#191fd0" fill="none" stroke-linecap="round" stroke-linejoin="round">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        <rect x="3" y="5" width="18" height="14" rx="2" />
        <polyline points="3 7 12 13 21 7" />
      </svg> Subscribe</h4> -->
